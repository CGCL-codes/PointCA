...
from utils.rfa_tf_util import mlp, mlp_conv, chamfer, add_train_summary, add_valid_summary, earth_mover
...
class Model:
    def __init__(self, inputs, gt, theta, is_training):
        ...
        self.net, self.gl_feature, self.coarse_highres, self.coarse, self.fine = self.completion(inputs, is_training)
    ...
    def completion(self, inputs, is_training):
        ...
        return up_gl_points, gl_feature, coarse_highres, coarse, fine
